# GameCI Multi-Platform XRDP Hub Image

## `unityci/multi-platform-xrdp-hub`

Unity Hub image for multi-platform builds supporting Windows, Android, and iOS, with optional GUI access via XRDP.
...
```bash
docker run -it --rm unityci/multi-platform-xrdp-hub:[tag] bash
```
